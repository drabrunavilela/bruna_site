  ...
  return (
    <>
      <SEO 
        ...
        keywords="contato dra bruna vilela, agendar consulta neuropediatra, neuropediatra belo horizonte, telefone dra bruna, whatsapp neuropediatra, endereço consultório"
        canonical="/contato"
