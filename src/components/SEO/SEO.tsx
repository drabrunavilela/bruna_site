...
const SEO: React.FC<SEOProps> = ({
  ...
  useEffect(() => {
    ...
    // Add LocalBusiness schema (deduplicado)
    ...
    const existingLocalBusinessScript = document.querySelector('script[type="application/ld+json"][data-localbusiness]');
    if (existingLocalBusinessScript) {
      existingLocalBusinessScript.remove();
    }

    const localBusinessScript = document.createElement('script');
    localBusinessScript.setAttribute('type', 'application/ld+json');
    localBusinessScript.setAttribute('data-localbusiness', 'true');
    localBusinessScript.textContent = JSON.stringify(localBusinessSchema);
    document.head.appendChild(localBusinessScript);

    // FAQ extenso removido para evitar over-optimization
